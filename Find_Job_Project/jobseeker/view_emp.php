...
<head>
    ...
    <title>Xem Nhà Tuyển Dụng</title>
</head>
...
<body>
        ...
        <nav>
            <div class="navbar" id="insidenav">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="#"> Xem Nhà Tuyển Dụng </a></li>
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="#">Xem Việc Làm Đã Chọn</a></li>
                        </ul>
                    </li>
                </ul>
    ...
    <div class="container-fluid" id="content">
        ...
        <aside class="col-sm-3 text-center" role="complementary" style="margin-top: 170px;">
            <div class="thumbnail text-center">
                ...
                <a class="btn-more"
                    href="jobs_by_emp.php?eid=<?php echo $empid; ?>&ename=<?php echo $result['Company_name']; ?>"
                    style="font-size: 16px;">Xem Tất Cả Các Tin Tuyển Dụng Của
                    <?php echo $result['Company_name']; ?>
                </a>
            </div>
        </aside>
        ...
        <section class="col-sm-9">
            <div class="container-fluid" style="margin-top: 30px;" id="tablecontent">
                <h2 style="text-align:left; color: var(--primary-color)">Doanh Nghiệp/Công Ty:
                    <?php echo $result['Company_name']; ?>
                </h2>
                ...
                <table class="table table-responsive">
                    ...
                    <tr>
                        <td class="tbold">Đỉa Chỉ Website:</td>
                        <td>
                            <?php echo $result['Website']; ?>
                        </td>
                    </tr>
                    <tr>
                        <td class="tbold">Thông Tin Công Ty/Doanh Nghiệp:</td>
                        <td>
                            <?php echo $result['Profile']; ?>
                        </td>
                    </tr>
                </table>
            </div>
