            ...
            (function (b) {
                ...
                function e(a, b) {
                    for (
                        ...
                        if (K.flags.dimensions.match(j))
                            ...
                            b.themes.hasOwnProperty(j) &&
                                (c.theme = y(b.themes[j], null)),
                                (l = !0);
                            ...
                            null == K.vars.cache.themeKeys &&
                                (K.vars.cache.themeKeys = Object.keys(
                                    b.themes
                                ));
                            var n =
                                K.vars.cache.themeKeys[
                                    0 |
                                        (Math.random() *
                                            K.vars.cache.themeKeys.length)
                                ];
                ...
                function f(a) {
                    ...
                    "image" == b
                        ? (("html" != o.renderer && d.auto) ||
                          ...
                          "html" == o.renderer
                              ? (c.style.backgroundColor = h.background)
                              : (g(r),
                                "exact" == d.textmode &&
                        ...
                        : "fluid" == b &&
                          ...
                          "html" == o.renderer
                              ? (c.style.backgroundColor = h.background)
                              : (K.vars.resizableImages.push(c), j(c)));
                }
                function g(a) {
                    function c() {
                        var b = null;
                ...
                function h(a) {
                    ...
                    switch (
                        ...
                        case "literal":
                            a.text =
                                a.flags.dimensions.width +
                                "x" +
                                a.flags.dimensions.height;
                            break;
                        case "exact":
                    ...
                    if (h.lineCount > 1) {
                        ...
                        (j = new e.Text(a.text)),
                            ...
                            g.add(k),
                            g.moveTo(
                                (a.width - h.boundingBox.width) / 2,
                                (a.height - h.boundingBox.height) / 2,
                                null
                            );
                    return d;
                }
                ...
                function j(a) {
                    var b;
                    b =
                        null == a || null == a.nodeType
                            ? K.vars.resizableImages
                            : [a];
                    ...
                    if (a.holderData) {
                        ...
                        if (b) {
                            var c = a.holderData.flags,
                                d = {
                                    fluidHeight:
                                        "%" == c.dimensions.height.slice(-1),
                                    fluidWidth:
                                        "%" == c.dimensions.width.slice(-1),
                                    mode: null,
                                    initialDimensions: b,
                                };
                ...
                function l() {
                    for (
                        var a,
                            c = [],
                            d = Object.keys(K.vars.invisibleImages),
                            e = 0,
                            f = d.length;
                        f > e;
                        e++
                ...
                function t(a) {
                    K.vars.debounceTimer || a.call(this),
                        K.vars.debounceTimer &&
                            b.clearTimeout(K.vars.debounceTimer),
                ...
                var v = c(1),
                    ...
                    J = {
                        ...
                        run: function (a) {
                            ...
                            (K.vars.preempted = !0),
                                (K.vars.dataAttr =
                                    g.dataAttr || K.vars.dataAttr),
                                (c.renderer = g.renderer
                                    ? g.renderer
                                    : K.setup.renderer),
                                -1 ===
                                    K.setup.renderers
                                        .join(",")
                                        .indexOf(c.renderer) &&
                                    (c.renderer = K.setup.supportsSVG
                                        ? "svg"
                                        : K.setup.supportsCanvas
                                        ? "canvas"
                                        : "html");
                            ...
                            for (l = 0; l < k.length; l++) {
                                ...
                                try {
                                    (B.data = A.getAttribute("data")),
                                        (B.dataSrc = A.getAttribute(
                                            K.vars.dataAttr
                                        ));
                                } catch (E) {}
                                var F =
                                        null != B.data &&
                                        0 === B.data.indexOf(g.domain),
                                    G =
                                        null != B.dataSrc &&
                                        0 === B.dataSrc.indexOf(g.domain);
                                F
                                    ? d(g, c, B.data, A)
                                    : G && d(g, c, B.dataSrc, A);
                            }
                            for (l = 0; l < h.length; l++) {
                                ...
                                try {
                                    (I.src = H.getAttribute("src")),
                                        (I.dataSrc = H.getAttribute(
                                            K.vars.dataAttr
                                        )),
                                        (I.rendered = H.getAttribute(
                                ...
                                var J = null != I.src,
                                    L =
                                        null != I.dataSrc &&
                                        0 === I.dataSrc.indexOf(g.domain),
                                    M =
                                        null != I.rendered &&
                                        "true" == I.rendered;
                                J
                                    ? 0 === I.src.indexOf(g.domain)
                                        ? d(g, c, I.src, H)
                                        : L &&
                                          (M
                                              ? d(g, c, I.dataSrc, H)
                    ...
                    L = (function () {
                        ...
                        return function (d) {
                            ...
                            if (K.setup.supportsSVG) {
                                ...
                                (null == a || a.parentNode !== document.body) &&
                                    (f = !0),
                                    (a = q(
                                        a,
                                        e.properties.width,
                    ...
                    M = (function () {
                        ...
                        return function (c) {
                            ...
                            (a.width = K.dpr(d.properties.width)),
                                ...
                                (b.fillStyle =
                                    d.children.holderBg.properties.fill),
                                b.fillRect(
                                    0,
                                    0,
                                    K.dpr(d.children.holderBg.width),
                                    K.dpr(d.children.holderBg.height)
                                );
                            {
                                ...
                                function (b, e) {
                                    ...
                                    p(k, { id: j }),
                                        ...
                                        p(d, {
                                            ...
                                            fill: f.children.holderBg.properties
                                                .fill,
                                        }),
                ...
                for (var O in K.flags)
                    K.flags.hasOwnProperty(O) &&
                        (K.flags[O].match = function (a) {
                    ...
                    (function () {
                        ...
                        d.getContext &&
                            ...
                            document.createElementNS &&
                                document.createElementNS(F, "svg")
                                    .createSVGRect &&
                                ((K.setup.renderer = "svg"),
                    ...
                    v &&
                        v(function () {
                            K.vars.preempted || J.run(),
                                b.addEventListener
                                    ? (b.addEventListener("resize", u, !1),
                                      b.addEventListener(
                                          "orientationchange",
                                          u,
                                          !1
                                      ))
                                    : b.attachEvent("onresize", u),
